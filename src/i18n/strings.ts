  ...
  es: {
    ...
    map: {
      ...
      cerca: {
        ...
        denied: "No pudimos acceder a tu ubicación. Actívala e inténtalo de nuevo.",
  ...
  va: {
    ...
    map: {
      ...
      cerca: {
        ...
        denied: "No hem pogut accedir a la teua ubicació. Activa-la i torna-ho a provar.",
  ...
  en: {
    ...
    map: {
      ...
      cerca: {
        ...
        denied: "We couldn't access your location. Enable it and try again.",
