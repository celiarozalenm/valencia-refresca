  ...
  es: {
    ...
    map: {
      ...
      cerca: {
        ...
        locating: "Buscando lo más cercano…",
        denied: "No has dado permiso de ubicación. Permítelo en tu navegador e inténtalo de nuevo.",
        failed: "No pudimos obtener tu ubicación. Inténtalo de nuevo (si abres la web dentro de otra app, ábrela en tu navegador).",
  ...
  va: {
    ...
    map: {
      ...
      cerca: {
        ...
        locating: "Buscant el més pròxim…",
        denied: "No has donat permís d'ubicació. Permet-lo al navegador i torna-ho a provar.",
        failed: "No hem pogut obtindre la teua ubicació. Torna-ho a provar (si obris la web dins d'una altra app, obri-la al navegador).",
  ...
  en: {
    ...
    map: {
      ...
      cerca: {
        ...
        locating: "Finding the closest…",
        denied: "You haven't granted location permission. Allow it in your browser and try again.",
        failed: "We couldn't get your location. Try again (if you opened the site inside another app, open it in your browser).",
